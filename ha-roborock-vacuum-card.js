...
class HARoborockVacuumCard extends HTMLElement {
  ...
  static getStubConfig() {
    return {
      ...
      vacuum: "vacuum.gunner_ren",
      map_image: "image.gunner_ren_hyacintvej",
      battery: "sensor.gunner_ren_battery",
      status_text: "sensor.gunner_ren_status_2",
      vacuum_error: "sensor.gunner_ren_vacuum_error",
      cleaning_area: "sensor.gunner_ren_cleaning_area",
      cleaning_time: "sensor.gunner_ren_cleaning_time",
      cleaning_progress: "sensor.gunner_ren_cleaning_progress",
      current_room: "sensor.gunner_ren_nuvaerende_rum",
      last_clean_start: "sensor.gunner_ren_sidste_rengoringsstart",
      last_clean_end: "sensor.gunner_ren_sidste_rengoringsafslutning",
      total_area: "sensor.gunner_ren_total_cleaning_area",
      total_count: "sensor.gunner_ren_total_cleaning_count",
      total_time: "sensor.gunner_ren_total_cleaning_time",
      dock_error: "sensor.gunner_ren_dock_dock_error",
      dock_mop_drying: "sensor.kokkenet_gunner_ren_dock_mop_drying_remaining_time",
      filter_left: "sensor.gunner_ren_filter_time_left",
      main_brush_left: "sensor.gunner_ren_main_brush_time_left",
      side_brush_left: "sensor.gunner_ren_side_brush_time_left",
      sensor_left: "sensor.gunner_ren_sensor_time_left",
      dock_maintenance_brush: "sensor.gunner_ren_dock_maintenance_brush_time_left",
      dock_strainer: "sensor.gunner_ren_dock_strainer_time_left",
      mop_attached: "binary_sensor.gunner_ren_mop_attached",
      water_box_attached: "binary_sensor.gunner_ren_water_box_attached",
      water_shortage: "binary_sensor.gunner_ren_water_shortage",
      mop_mode: "select.gunner_ren_mop_mode",
      mop_intensity: "select.gunner_ren_mop_intensity",
      dock_empty_mode: "select.gunner_ren_dock_empty_mode",
      cleaning_mode: "select.kokkenet_gunner_ren_cleaning_mode",
      volume: "number.gunner_ren_volume",
      child_lock: "switch.gunner_ren_child_lock",
      dnd_switch: "switch.gunner_ren_dnd_switch",
      dock_light: "switch.gunner_ren_dock_status_indicator_light",
      dock_dust_emptying: "switch.kokkenet_gunner_ren_dock_dust_emptying",
      dnd_begin: "time.gunner_ren_do_not_disturb_begin",
      dnd_end: "time.gunner_ren_do_not_disturb_end",
      quick_clean: [
        { entity: "button.gunner_ren_full_cleaning", name: "Hele huset" },
        { entity: "button.gunner_ren_kokken_stuer", name: "Køkken & stuer" },
        { entity: "button.gunner_ren_mads_viggo", name: "Mads & Viggo" },
      ],
      rooms: [],
    };
  }
  ...
  _render() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      *{box-sizing:border-box}
      ...
      .fan-row button{flex:1;min-width:60px;padding:8px 4px;border:1px solid var(--edge);border-radius:10px;background:transparent;color:var(--secondary-text-color);font-size:10px;font-weight:700;text-transform:capitalize;cursor:pointer}
      .fan-row button.active{border-color:var(--accent);background:color-mix(in srgb,var(--accent) 18%,transparent);color:var(--primary-text-color)}
      ...
      .quick-row button{flex:1;min-width:100px;padding:9px 6px;border:1px solid var(--edge);border-radius:10px;background:transparent;color:var(--primary-text-color);font-size:10px;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:6px}
      ...
      .clean-selected{width:100%;margin-top:10px;padding:10px;border:0;border-radius:12px;background:var(--accent);color:#fff;font-weight:700;font-size:12px;cursor:pointer}
      .clean-selected:disabled{opacity:.4;cursor:default}
